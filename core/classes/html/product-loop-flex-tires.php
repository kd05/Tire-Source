...
/**
 * Class Product_Loop_Flex_Tires
 */
Class Product_Loop_Flex_Tires extends Product_Loop_Flex{

	public function __construct(){
		parent::__construct();
		$this->add_css_class( 'product-loop-tires' );
		$this->set_item_defaults( array(
			'item_outer_add_class' => 'type-tire',
		));
	}
