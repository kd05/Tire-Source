...
Class SIS_Fastco_Tires_CA extends Supplier_Inventory_Supplier {

    const HASH_KEY = Supplier_Inventory_Hash::KEY_FASTCO_TIRES_CA;
    ...
    public function prepare_for_import() {
        ...
        $data = Product_Sync_Fastco::get_tires_ca_data();
