...
/**
 * Tires import for CDA Tire supplier
 *
 * Class Supplier_Inventory_Hash
 */
Class SIS_CDA_Tire_Tires_Canada extends Supplier_Inventory_Supplier {

    const HASH_KEY = Supplier_Inventory_Hash::KEY_CDA_TIRE_TIRES_CA;

    /**
     * Supplier_Inventory_Hash constructor.
     */
