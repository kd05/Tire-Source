...
$delete_rims = gp_if_set( $_POST, 'delete_rims' );

if ( $delete_rims && is_array( $delete_rims ) ) {
	foreach ( $delete_rims as $part_number=>$delete ) {

		if ( ! $delete || $delete === '0' || $delete === 'false' )
			continue;

		// RIMS RIMS RIMS RIMS RIMS *********** dont get confused with tires
